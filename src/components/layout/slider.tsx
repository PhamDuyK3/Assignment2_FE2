...
const Slider = () => {
  const images = [
    "https://media.canifa.com/Simiconnector/BannerSlider/h/o/homepage_desktop_2880x960.webp",
    "https://media.canifa.com/Simiconnector/BannerSlider/h/o/homepage_desktop_2880x960-3.webp",
    "https://media.canifa.com/Simiconnector/BannerSlider/h/o/homepage_desktop_2880x960_1_.webp",
    "https://pos.nvncdn.net/b3bf61-16762/bn/20230614_usb8NQiN.jpeg",
  ];
